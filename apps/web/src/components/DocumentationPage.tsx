    ...
    topics: [
      ...
      },
      {
        ...
        cards: [
          ...
          { name: "Training Dataset", meaning: "Shipment, coverage, sufficient, cold start, excluded, edges.", reading: "Cold start dipetakan konservatif setelah training." },
          ...
          { name: "Cluster Profiles", meaning: "Members, common tags, shift, pair, membership.", reading: "Common tag minimal 50% anggota." },
          { name: "Membership", meaning: "HDBSCAN membership dan noise.", reading: "Noise/Unique Pattern adalah hasil valid." },
    ...
    topics: [
      {
        ...
        steps: [
          ...
          { title: "Upload input", text: "LO wajib 8 KL per row; MT Availability berisi kendaraan dan initial available datetime." },
      ...
      },
      {
        ...
        cards: [
          ...
          { name: "3. LO Upload", meaning: "LO, start time, SPBU, quantity 8 KL.", reading: "Preview adalah normalized input." },
          { name: "4. MT Availability", meaning: "MT unik, aktif, satu depot, initial time.", reading: "Menjadi rolling state awal." },
          ...
          { name: "7–8. Shipment & Assignment", meaning: "Grouping, MT, compartment, timeline, score, status.", reading: "Expand untuk explanation, route, candidate, exclusion, override." },
          ...
          { name: "10B. Geographic Route", meaning: "Master markers dan route geometry per MT.", reading: "Solid=road geometry; dashed=fallback." },
          { name: "11. Run History", meaning: "Immutable run, status, View, Export, Re-run.", reading: "Failed run dapat retry dari saved input." },
      ...
      },
      {
        ...
        paragraphs: [
          "Grouping hanya mempertimbangkan LO dalam derived shift yang sama, gap waktu, minimum pairing confidence, 1–4 LO, capacity, detour ratio, dan non-overlap set packing. Kandidat MT melewati master compatibility hard filter untuk seluruh SPBU.",
        ],
        formulas: [
