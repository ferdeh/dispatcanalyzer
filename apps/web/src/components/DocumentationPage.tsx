    ...
    topics: [
      ...
      },
      {
        ...
        cards: [
          ...
          { name: "Parameter", meaning: "Objective, solver, biaya, registry constraint HARD/SOFT/disabled, time limit, penalty, serta Vehicle Activation Cost Rules.", reading: "MT Working Time menyimpan limit menit langsung pada rule. Priority activation memilih rule biaya yang menang; activation cost memengaruhi objective, bukan compatibility. Save membuat profile version dan setiap run menyalin effective snapshot + checksum." },
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Satu MT fisik dapat menjalankan Trip 1, kembali ke depot, masuk queue/loading lagi, lalu menjalankan Trip 2 selama availability, working time, compartment, bay, time window, dan depot close masih feasible. MT Working Time dihitung kumulatif dari mulai MT digunakan, termasuk queue/loading, route dan service, sampai kembali ke depot. Initial reference time menjadi batas paling awal MT dan route; Re-optimize reference time menjadi current time untuk freeze.",
